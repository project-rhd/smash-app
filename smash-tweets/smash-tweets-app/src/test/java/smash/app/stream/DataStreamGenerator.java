...
//      hdfs://smash-1-master:9000/tweets/geoTweets_mel_new.json
      JavaRDD<String> rawJson = sc.textFile("hdfs://smash-1-master:9000/tweets/geoTweets_melb_Jun_Dec_2017.json");  //hdfs://smash-1-master:9000/tweets/geoTweets_melb_2017.json
      ...
      tweetStrs.foreachPartition(tweetIter->{
        ...
        tweetIter.forEachRemaining(tweetStr->{
          try{
            ...
            Thread.sleep(1l); //4-500 2-900 3-600 1-1600 10-200 50-40 100
          }catch (Exception e){
